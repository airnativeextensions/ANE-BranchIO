package io.branch.nativeExtensions.branch
{
	...
	public class Branch extends EventDispatcher
	{
		...
		[Deprecated(message="Use initSession( options )")]
		/**
		 * <p>
		 ...
		 * <code>BranchEvent.INIT_SUCCESS</code> event.
		 * </p>
		 *
		 * @example
		 *
		 ...
		 * Be sure to listen <code>GET_CREDITS_HISTORY_SUCCESS</code> and <code>GET_CREDITS_HISTORY_FAILED</code> events.
		 *
		 * @param bucket The bucket to get credits balance from.
		 */
		...
		{
			return new _BranchUniversalObject(
					_extensionContext
			);
		}
		...
		public function disableTracking( disabled:Boolean ):Boolean
		{
			try
			{
				return _extensionContext.call( "disableTracking", disabled );
			}
			catch (e:Error)
			{
			}
